...
Heurísticas que o `solucao-screen-translator` usa para classificar a plataforma origem do legado a partir do conteúdo de `_solucao_sdd/inventory.md` e do código fonte. Use junto com `references/adapter-pairs.md` para escolher o adapter.
