...
- **Telas geradas**: <N>
- **Adapter**: <slug>
- **Tokens consumidos**: ver `_solucao_sdd/design-system/tokens.md` e `tokens-derived.md` quando aplicável
- **Golden files**: <N> em `_solucao_sdd/screens/golden/` (manifest em `golden/manifest.yaml`)
...
**Tela crítica?**: sim | não (consulta `solucao-detective` quando disponível)
