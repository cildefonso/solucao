...
- ⚠️ **{{this.item}}** — afeta Tarefa {{this.task_number}} ({{this.task_name}}). Origem: `_solucao_sdd/migration/ambiguity_log.md`
{{/each}}
...
**Status:** pending
**Lê:** `_solucao_sdd/migration/topology_decision.md`, `_solucao_sdd/migration/paradigm_decision.md`
...
**Status:** pending
**Lê:** `_solucao_sdd/migration/target_data_model.md`
...
**Status:** pending
**Lê:** `_solucao_sdd/migration/data_migration_plan.md`, `_solucao_sdd/migration/target_data_model.md`
...
**Status:** pending
**Lê:** `_solucao_sdd/migration/cutover_plan.md`
...
**Status:** pending
**Lê:** `_solucao_sdd/migration/parity_specs.md`, `_solucao_sdd/migration/parity_tests/[lista de arquivos .feature]`
