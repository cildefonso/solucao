...
description: >
  ...
  pelo Time Solucao Docs, usa Three.js servido localmente em assets/vendor/ (offline-first).
license: MIT
...
<head>
    ...
    <style>
        ...
        /* Estilo Solucao: variantes derivam de data-style do <body> via CSS externo do agente */
    </style>
</head>
