...
**Spec afetada:** [`_solucao_sdd/<unit>/{requirements|design|tasks}.md`]
...
2. Avisar ao Revisor quando terminar (digitar `solucao` ou "respondi as perguntas")
...
**Spec afetada:** [`_solucao_sdd/auth/requirements.md`]
...
**Spec afetada:** [`_solucao_sdd/orders/requirements.md`]
