---
name: solucao-highcharts-visualizer
license: MIT
...
1. **HTML standalone**: arquivo único `.html`. Quando rodada pelo Time Solucao Docs, Highcharts vem de `assets/vendor/` (baixado pelo Publisher via `vendor-pins.yaml`). Quando rodada isoladamente, aceita CDN como fallback mas o caminho preferido é local.
