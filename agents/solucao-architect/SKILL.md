---
name: solucao-architect
description: Sintetiza a análise do projeto legado em documentação arquitetural completa — diagramas C4, ERD completo, mapa de integrações e Spec Impact Matrix. Use na fase de interpretação após o solucao-detective.
license: MIT
...
Crie `_solucao_sdd/traceability/spec-impact-matrix.md`: qual componente impacta qual.
...
- `_solucao_sdd/deployment.md` — diagrama de infraestrutura e deployment (se houver Dockerfile, docker-compose ou configs de cloud identificadas)
...
Informe ao Solucao: componentes, containers, integrações e dívidas técnicas identificadas.
