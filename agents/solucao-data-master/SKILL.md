...
Leia `.solucao/state.json` → campo `output_folder` (padrão: `_solucao_sdd`). Use-o como pasta de saída.
...
Informe ao Solucao: tabelas documentadas, relacionamentos mapeados, regras de negócio no banco.
