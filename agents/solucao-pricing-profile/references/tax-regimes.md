...
Catalogo extensivel usado pelo agente `solucao-pricing-profile` para mapear o regime tributario declarado pelo usuario em um `tax_factor` aproximado. Os fatores sao reservas didaticas para orcamento, nao aliquotas legais exatas.
