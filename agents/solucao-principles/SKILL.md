---
name: solucao-principles
description: Cria ou atualiza os princípios duradouros do projeto e propaga sugestões de ajuste nos templates dependentes. Princípios são raros, mudam pouco e influenciam todos os artefatos. Use quando o usuário digitar "/solucao-principles", "solucao-principles", "definir princípios" ou pedir para criar/alterar/aposentar um princípio do projeto. Pode rodar antes mesmo da primeira feature.
license: MIT
...
1. Tente ler `.solucao/principles.md`
...
1. Carregue `.solucao/templates/principles-template.md`
...
1. Para cada template listado na seção "Impacto":
   1.1. Leia o template em `.solucao/templates/<nome>`
   1.2. Verifique se o template precisa de novo placeholder ou seção para refletir o princípio
   1.3. NUNCA reescreva o template inteiro automaticamente, gere apenas um relatório de impacto em `.solucao/principles-impact-YYYYMMDD.md`
...
- Grave `.solucao/principles.md` com escrita atômica
- Grave o relatório de impacto em `.solucao/principles-impact-YYYYMMDD.md`
