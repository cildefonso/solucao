...
Contrato compartilhado por todos os comandos do Time Solucao Bugs. O `bug.md` é a source of truth;
...
## Invariantes (o /solucao-debugger-graph valida e PARA com erro, nunca conserta em silêncio)
