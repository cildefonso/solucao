...
- `_solucao_sdd/migration/target_business_rules.md` (Curator concluído)
...
- `_solucao_sdd/migration/migration_strategy.md`
- `_solucao_sdd/migration/risk_register.md`
- `_solucao_sdd/migration/cutover_plan.md`
...
- Não modificar artefatos fora de `_solucao_sdd/migration/`.
