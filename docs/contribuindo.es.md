...
├── bin/                ← punto de entrada del CLI (solucao.js)
├── lib/
...
1. Crea la carpeta `agents/solucao-[nombre]/`
...
MIT. Ver [LICENSE](https://github.com/cildefonso/solucao/blob/main/LICENSE) para los detalles.
