...
├── bin/                ← CLI entry point (solucao.js)
├── lib/
...
1. Create the folder `agents/solucao-[name]/`
...
MIT. See [LICENSE](https://github.com/cildefonso/solucao/blob/main/LICENSE) for details.
