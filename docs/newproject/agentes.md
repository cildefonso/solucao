...
**Produces:** `_solucao_sdd/newproject-brief.md` and the orchestrator state under `state.json#newproject_progress`.
...
**Produces:** `_solucao_sdd/ideation.md`.
...
**Produces:** `_solucao_sdd/personas.md`.
...
**Produces:** `_solucao_sdd/prd.md`.

---

## 5. Spec SDD

**Command:** `/solucao-spec-sdd`
...
**Produces:** `_solucao_sdd/sdd/<component>.md` (one per component).
