...
**Produz:** `_solucao_sdd/newproject-brief.md` e o estado do orquestrador em `state.json#newproject_progress`.
...
**Produz:** `_solucao_sdd/ideation.md`.
...
**Produz:** `_solucao_sdd/personas.md`.
...
**Produz:** `_solucao_sdd/sdd/<componente>.md` (um por componente).
