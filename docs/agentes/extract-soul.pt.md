...
Se `_solucao_sdd/soul.md` já existir, o agente NÃO sobrescreve. Ele oferece duas opções: manter o original e abortar, ou gerar um irmão datado como `_solucao_sdd/soul.20260509-1430.md`.
