...
Solucao coordina **8 Teams especializados** de agentes. Cada agente hace una cosa y la hace bien; cada Team agrupa a los agentes en torno a una fase del trabajo.
...
|------|---------|------------------|
| **Solucao Agents Core** | Descubrimiento y orquestación del legado: mapea, excava, interpreta y documenta. Detallado en las tablas siguientes. | Siempre instalado |
...
Las tablas siguientes detallan los agentes que componen el Team **Solucao Agents Core**.
