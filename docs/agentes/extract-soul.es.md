...
Si `_solucao_sdd/soul.md` ya existe, el agente NO sobrescribe. Ofrece dos opciones: mantener el original y abortar, o generar un hermano fechado como `_solucao_sdd/soul.20260509-1430.md`.
