...
Solucao coordinates **8 specialized Teams** of agents. Each agent does one thing and does it well; each Team groups agents around a phase of the work.

The central orchestrator (Solucao itself) coordinates who enters when, in what order, and at what pace. But you can also trigger any agent directly when you need to.
...
The tables below detail the agents that make up the **Solucao Agents Core** Team.
...
```
/solucao → orchestrates everything automatically
