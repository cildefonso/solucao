...
If `_solucao_sdd/soul.md` already exists, the agent does NOT overwrite. It offers two options: keep the original and abort, or generate a dated sibling like `_solucao_sdd/soul.20260509-1430.md`.
