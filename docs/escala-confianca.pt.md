...
Uma das partes mais importantes do Solucao é a honestidade. O sistema não finge saber o que não sabe.
...
Lacunas que não puderam ser respondidas ficam em `_solucao_sdd/gaps.md` para tratamento posterior.
