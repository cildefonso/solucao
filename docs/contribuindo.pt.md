...
├── bin/                ← ponto de entrada do CLI (solucao.js)
├── lib/
...
1. Crie a pasta `agents/solucao-[nome]/`
...
MIT. Veja [LICENSE](https://github.com/cildefonso/solucao/blob/main/LICENSE) para os detalhes.
