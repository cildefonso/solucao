...
- Use 🟢 / 🟡 / 🔴 conforme a confidência da fonte do _solucao_sdd/ que sustenta a afirmação.
...
> Data: `YYYY-MM-DD`
> Pasta da extração solucao: `_solucao_sdd/`
...
<!--
Liste os artefatos da pipeline solucao que sustentam essa feature.
Cada citação no formato _solucao_sdd/<arquivo>#<seção>.
