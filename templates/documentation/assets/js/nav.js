/*
 * Solucao Documentation - Helper de navegação
 *
...
(function () {
    ...
    const STORAGE_KEY_THEME = "solucao.doc.theme";
     ...
     */
    function renderNav() {
        const nav = document.querySelector(".solucao-doc-nav");
        if (!nav) return;
    ...
    function highlightActiveLink() {
        ...
        const links = document.querySelectorAll(".solucao-doc-nav a[href]");
        links.forEach((link) => {
    ...
    function scrollBySection(direction) {
        const sections = Array.from(document.querySelectorAll(".solucao-doc-main h2, .solucao-doc-main h3"));
