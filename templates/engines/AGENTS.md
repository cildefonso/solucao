...
Quando o usuário digitar `solucao` sozinho em uma mensagem:

1. Ative o skill `solucao` disponível em `.agents/skills/solucao/SKILL.md`
2. Leia o SKILL.md na íntegra e siga exatamente as instruções do Solucao
